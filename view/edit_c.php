...
<?php 
    ...
    if(isset($_POST['username'])){
        ...
        $user1 = new reclamation($_POST['username'],$_POST['type_rec'],$_POST['desc']);
        echo '<pre>';
            var_dump($user1);
        echo '</pre>';
        $userG=new recC();
        
        $userG->editC($user1,$id);
       // var_dump($userG);
					...
					<div class="request-a-call-back-form-vertical-two">
                        ...
                        <form method="POST">
                            ...
                            <div class="col-lg-12">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<label for="type">chosie type:</label>

										<select name="type_rec" id="type_rec"  class="custom-select-categories">
										 <option  value="'.$type.'">Volvo</option>
								...
								<div class="col-lg-12">
									<div class="form-group">
										<input type="text" placeholder="description" value="'.$desc.'" name="desc" class="form-control">
									</div>
								</div>
