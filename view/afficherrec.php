...
<body>
			...
			<div class="row align-items-center">
				...
				<div class="col-md-12 col-xl-12 wow fadeInLeft mrb-lg-40" data-wow-delay="0ms" data-wow-duration="1000ms">
					<div class="request-a-call-back-form-vertical-two">
						<div class="row">
                            <h3 class="mrt-0 mrb-30 col-md-8">reclamation list</h3>
                            <div class="col-md-4">
                                <a class="btn btn-success float-right mr-5" href="ajouterRec.php">neauveaux Reclamation</a>
                            </div>
                        </div>
	...
	<a class="btn btn-primary" href="edit_c.php?id=<?php echo $row['id'] ?>"<?php if(($row['status'])>0) echo 'style="display:none"';?>>Edit</a>
                                            <a class="btn btn-danger" href="supprimer_c.php?id=<?php echo $row['id'] ?>"<?php if(($row['status'])>0) echo 'style="display:none"';?>>Delete</a>
