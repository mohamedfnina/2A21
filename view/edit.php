...
<?php 
    ...
    $req = mysqli_query($con,$sql) or die ($sql."<br>".mysqli_error()) ;
    $p_db = mysqli_fetch_assoc($req);

    $userName   = $p_db["userName"];
    $firstName  = $p_db["firstName"];
    $lastName   = $p_db["lastName"];
    $email      = $p_db["email"];
    $password   = $p_db["pwd"] ;
	...
	<section class="pdt-120 pdb-120" data-background="images/bg/1.jpg">
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-md-12 col-xl-6 m-auto wow fadeInLeft mrb-lg-40" data-wow-delay="0ms" data-wow-duration="1000ms">
					<div class="request-a-call-back-form-vertical-two">
						<h3 class="mrt-0 mrb-30">Edit</h3>
						<?php
                        echo'
                        <form method="POST">
							<div class="row">
                            <div class="col-lg-12">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<input type="text" placeholder="First Name" value="'.$firstName.'" name="firstName" class="form-control">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
										<input type="text" placeholder="Last Name" value="'.$lastName.'" name="lastName" class="form-control">
									</div>
								</div>
                                <div class="col-lg-12">
									<div class="form-group">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<input type="email" placeholder="Email" value="'.$email.'" name="email" class="form-control">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group mrb-0">
										<button type="submit" class="cs-btn-one btn-primary-color btn-md btn-block">Update</button>
									</div>
								</div>
							</div>
						</form>
